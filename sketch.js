...
var backSprite;
var obstacle, obstImg1, obstImg2, obstImge3;
var score = 0;
...
function preload(){
  ...
  obstImg1 = loadImage("images/spikeSprite.png");
  obstImg2 = loadImage("images/bombImg.png");
  obstImg3 = loadImage("images/crabSprite.png");
}
...
function draw() {
  ...
  if(gameState === PLAY){
    ...
    fill("black");
    textSize(25);
    text("Score: " + score, width - width + 30, height - height + 40);
...
function spawnObstacles(){
  if(frameCount % 99 === 0 || frameCount % 253 === 0){
    obstacle = createSprite(width, ground.y - 110, 50, 50);
